...
export function HomeHero() {
  return (
    <section className="grid gap-6 rounded-[36px] border border-slate-200/70 bg-white/85 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur md:grid-cols-[1.1fr_0.9fr] md:p-8">
      <div className="space-y-5">
        <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-sm font-medium text-emerald-800">
          ...
          Señales claras, topes visibles y fuentes originales
        </div>
        ...
        <BenefitSearchBar redirectTo="/explorar" className="max-w-2xl" />
