    ...
    <section className="rounded-[32px] border border-slate-200/80 bg-[linear-gradient(135deg,_rgba(15,23,42,1),_rgba(30,41,59,0.95)_45%,_rgba(49,46,129,0.92)_100%)] p-6 text-white shadow-[0_30px_80px_rgba(15,23,42,0.18)] md:p-8">
      <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
        <div className="flex flex-col justify-between gap-8">
          ...
          <div className="grid gap-3 rounded-[28px] border border-white/10 bg-white/6 p-5 text-sm text-slate-100 sm:grid-cols-2">
        ...
        <BenefitMedia
          ...
          priority
          className="min-h-72 rounded-[28px] border border-white/10 shadow-[0_24px_60px_rgba(0,0,0,0.2)] lg:min-h-full"
        />
      </div>
    </section>
  )
